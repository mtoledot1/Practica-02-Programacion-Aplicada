...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private VentanaRegistrarPersona registrarUsuario;
    private VentanaGestionTelefono gestionTelefono;
    private VentanaGestionPersona gestionPersona;
	...
	controladorTelefono = new ControladorTelefono();
        controladorPersona = new ControladorPersona(controladorTelefono);
	
	if(controladorPersona.buscar("0104760517").isEmpty()){
	    controladorPersona.crear("0104760517",
				    "sebastian",
				    "toledo",
                                    LocalDate.parse("23-12-1998", DateTimeFormatter.ofPattern("dd-MM-yyyy")),
				    "tano",
				    "1234");
	}
	/*controladorPersona.registrar("0105698123",
				    "pepito",
				    "perez",
				    "pepito001",
				    "54321");
	controladorPersona.iniciarSesion("mtoledot1","12345");
	...
	controladorTelefono.registrar(controladorTelefono.cantidadTelefonos(),
					...
					"Móvil",
					"CNT");
	controladorPersona.iniciarSesion("pepito001","54321");
	controladorTelefono.registrar(controladorTelefono.cantidadTelefonos(),
					"(+593)-0-996-5432",
					"Móvil",
					"Movistar");*/
	
	iniciarSesion = new VentanaIniciarSesion(controladorPersona, this);
	registrarUsuario = new VentanaRegistrarPersona(controladorPersona);
	gestionTelefono = new VentanaGestionTelefono(controladorTelefono, controladorPersona);
	gestionPersona = new VentanaGestionPersona(controladorTelefono, controladorPersona);
	buscarTelefono = new VentanaBuscarTelefono(controladorPersona, controladorTelefono);
    }
    ...
    private void initComponents() {
        ...
        registrarUsrMenuItem.setText("Registrar Persona");
        ...
        usuarioMenuItem.setText("Personas");
    ...
    private void usuarioMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_usuarioMenuItemActionPerformed
        desktopPane.add(gestionPersona);
	...
	gestionPersona.dispose();
	buscarTelefono.dispose();
	menuGestion.setVisible(false);
	cerrarMenuItem.setVisible(false);
	//controladorPersona.cerrarSesion();
