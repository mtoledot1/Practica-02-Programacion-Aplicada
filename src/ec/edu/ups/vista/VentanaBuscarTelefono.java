...
public class VentanaBuscarTelefono extends javax.swing.JInternalFrame {
    ...
    public VentanaBuscarTelefono(ControladorPersona controladorPersona, ControladorTelefono controladorTelefono) {
	initComponents();
	...
	if(rBtnGroup.isSelected(rBtnCedula.getModel())){
	    str = txtCedula.getText();
            persona = controladorPersona.buscar(str);
	}else{
	    str = txtCorreo.getText();
            persona = controladorPersona.buscarCorreo(str);
	}
	if(persona.isPresent()){
	    txtCedula.setText(persona.get().getCedula().trim());
	    ...
	    controladorPersona.telefonosPersona(persona.get(), (DefaultTableModel) tablaTelefonos.getModel());
	}else{
