...
public class VentanaGestionTelefono extends javax.swing.JInternalFrame {
    ...
    public VentanaGestionTelefono(ControladorTelefono controladorTelefono, ControladorPersona controladorPersona) {
	initComponents();
	this.controladorPersona = controladorPersona;
	this.controladorTelefono = controladorTelefono;
	int codigo = (controladorTelefono.generarId());
	...
	controladorTelefono.crear(numero, tipo, operadora);
        controladorPersona.agregarTelefono(new Telefono(controladorTelefono.generarId()-1, numero, tipo, operadora));
	txtCodigo.setText((controladorTelefono.generarId()) + "");
	controladorPersona.verTelefonosSesion((DefaultTableModel) tablaTelefonos.getModel());
	limpiar();
	...
	txtCodigo.setText((controladorTelefono.generarId()) + "");
        controladorPersona.eliminarTelefono(new Telefono(codigo, "", "", ""));
	controladorPersona.verTelefonosSesion((DefaultTableModel) tablaTelefonos.getModel());
	limpiar();
	...
	String tipo = (String)cbxTipo.getSelectedItem();
	String operadora = (String)cbxOperadora.getSelectedItem();
	String cedula = controladorPersona.getSesion().getCedula();
	controladorTelefono.actualizar(codigo, numero, operadora, tipo);
        controladorPersona.actualizarTelefono(new Telefono(codigo, numero, tipo, operadora));
	txtCodigo.setText((controladorTelefono.generarId()) + "");
	controladorPersona.verTelefonosSesion((DefaultTableModel) tablaTelefonos.getModel());
	limpiar();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        String numero = fTxtNumero.getText();
	if(!numero.isEmpty()){
	    List<Telefono> telefonos = controladorTelefono.getList();
